...
function Wheater() {
    ...
    <div className=' mt-10 flex w-full place-content-center'>
        <div className='grid grid-cols-2 gap-3'>
            ...
            <button  onClick={() => navigate(`/search/${city}`)} className='bg-red-800 w-20 text-center text-white flex justify-center items-center p-2 rounded-xl'><FaSearch className={"font-3xl"}/></button>
        </div>
    </div>
        </>
  )
